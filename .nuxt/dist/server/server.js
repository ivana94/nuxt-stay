...
/******/ 			var chunk = require("./" + ({"1":"components/home-card","2":"components/home-row","3":"components/image-uploader","4":"components/property-description","5":"components/property-details","6":"components/property-gallery","7":"components/property-host","8":"components/property-map","9":"components/property-reviews","10":"components/short-text","11":"pages/admin","12":"pages/admin/homes","13":"pages/home/_id","14":"pages/index","15":"pages/no-access","16":"pages/search"}[chunkId]||chunkId) + ".js");
...
const _0ef17ddc = () => interopDefault(__webpack_require__.e(/* import() | pages/admin */ 11).then(__webpack_require__.bind(null, 48)));

const _0b94e5fe = () => interopDefault(__webpack_require__.e(/* import() | pages/admin/homes */ 12).then(__webpack_require__.bind(null, 49)));

const _4eae467d = () => interopDefault(__webpack_require__.e(/* import() | pages/no-access */ 15).then(__webpack_require__.bind(null, 53)));

const _7e81eb6b = () => interopDefault(__webpack_require__.e(/* import() | pages/search */ 16).then(__webpack_require__.bind(null, 50)));

const _88973ae6 = () => interopDefault(__webpack_require__.e(/* import() | pages/home/_id */ 13).then(__webpack_require__.bind(null, 51)));

const _44fbac42 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 14).then(__webpack_require__.bind(null, 52)));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/error.vue?vue&type=template&id=3c366a14&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticStyle:{"text-align":"center"}},[_vm._ssrNode("<h1>Error!</h1> <div>"+_vm._ssrEscape(_vm._s(_vm.error.message)+" "+_vm._s(_vm.error.statusCode))+"</div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./layouts/error.vue?vue&type=template&id=3c366a14&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=26c2ddda&
var defaultvue_type_template_id_26c2ddda_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"app"},[_vm._ssrNode("<header class=\"app-header\">","</header>",[_c('nuxt-link',{attrs:{"to":"/"}},[_c('div',{staticClass:"app-logo"},[_c('img',{attrs:{"src":"/images/logo.svg"}})])]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"app-search\">","</div>",[_vm._ssrNode("<input type=\"text\" placeholder=\"enter your address\"> "),_c('client-only',{scopedSlots:_vm._u([{key:"placeholder",fn:function(){return [_c('input',{staticClass:"datepicker"}),_vm._v(" "),_c('input',{staticClass:"datepicker"})]},proxy:true}])},[_vm._v(" "),_c('date-picker',{attrs:{"is-range":"","timezone":"UTC","modelConfig":{ timeAdjust: '00:00:00' }},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var inputValue = ref.inputValue;
var inputEvents = ref.inputEvents;
return [_c('input',_vm._g({staticClass:"datepicker",attrs:{"placeholder":"from"},domProps:{"value":inputValue.start}},inputEvents.start)),_vm._v(" "),_c('input',_vm._g({staticClass:"datepicker",attrs:{"placeholder":"to"},domProps:{"value":inputValue.end}},inputEvents.end))]}}]),model:{value:(_vm.range),callback:function ($$v) {_vm.range=$$v},expression:"range"}})],1),_vm._ssrNode(" <button><img src=\"/images/icons/search.svg\"></button>")],2),_vm._ssrNode(" <div class=\"app-user-menu\">"+((_vm.isLoggedIn)?("<img"+(_vm._ssrAttr("src",_vm.user.profileUrl))+" class=\"avatar\">"):"<!---->")+" <div id=\"googleButton\" class=\"ml-8\""+(_vm._ssrStyle(null,null, { display: (!_vm.isLoggedIn) ? '' : 'none' }))+"></div></div>")],2),_vm._ssrNode(" "),_c('nuxt'),_vm._ssrNode(" "),_vm._ssrNode("<footer>","</footer>",[_c('nuxt-link',{attrs:{"to":"/admin"}},[_c('div',[_vm._v("\n                Admin panel\n            ")])]),_vm._ssrNode(" <div class=\"logout cursor-pointer\">Logout</div> <div>© Matijevic 2021</div>")],2)],2)}
var defaultvue_type_template_id_26c2ddda_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=26c2ddda&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  ...
  defaultvue_type_template_id_26c2ddda_render,
  defaultvue_type_template_id_26c2ddda_staticRenderFns,
  false,
  null,
  null,
  "f653a5cc"
...
const components = {
  HomeCard: () => __webpack_require__.e(/* import() | components/home-card */ 1).then(__webpack_require__.bind(null, 45)).then(c => wrapFunctional(c.default || c)),
  HomeRow: () => __webpack_require__.e(/* import() | components/home-row */ 2).then(__webpack_require__.bind(null, 38)).then(c => wrapFunctional(c.default || c)),
  ImageUploader: () => __webpack_require__.e(/* import() | components/image-uploader */ 3).then(__webpack_require__.bind(null, 35)).then(c => wrapFunctional(c.default || c)),
  PropertyDescription: () => __webpack_require__.e(/* import() | components/property-description */ 4).then(__webpack_require__.bind(null, 41)).then(c => wrapFunctional(c.default || c)),
  PropertyDetails: () => __webpack_require__.e(/* import() | components/property-details */ 5).then(__webpack_require__.bind(null, 40)).then(c => wrapFunctional(c.default || c)),
  PropertyGallery: () => __webpack_require__.e(/* import() | components/property-gallery */ 6).then(__webpack_require__.bind(null, 39)).then(c => wrapFunctional(c.default || c)),
  PropertyHost: () => __webpack_require__.e(/* import() | components/property-host */ 7).then(__webpack_require__.bind(null, 44)).then(c => wrapFunctional(c.default || c)),
  PropertyMap: () => __webpack_require__.e(/* import() | components/property-map */ 8).then(__webpack_require__.bind(null, 42)).then(c => wrapFunctional(c.default || c)),
  PropertyReviews: () => __webpack_require__.e(/* import() | components/property-reviews */ 9).then(__webpack_require__.bind(null, 43)).then(c => wrapFunctional(c.default || c)),
  ShortText: () => __webpack_require__.e(/* import() | components/short-text */ 10).then(__webpack_require__.bind(null, 34)).then(c => wrapFunctional(c.default || c))
};
...
async function _imageMeta(url) {
  if (true) {
    const imageMeta2 = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(null, 29, 7)).then(r => r.default || r);
...
const ipx_getImage = (src, {
  ...
  return {
    url: Object(dist["joinURL"])(nuxtBase, baseURL, Object(dist["encodePath"])(src) + (params ? "?" + params : ""))
  };
};
...
/* harmony default export */ var dataApi = (function ({
  ...
  async function getHome(homeId) {
    try {
      return Object(fetchUtils["b" /* unwrap */])(await fetch(`https://${$config.algolia.appId}-dsn.algolia.net/1/indexes/homes/${homeId}`, {
        headers
      }));
    } catch (error) {
  ...
  async function getReviewsByHomeId(homeId) {
    try {
      return Object(fetchUtils["b" /* unwrap */])(await fetch(`https://${$config.algolia.appId}-dsn.algolia.net/1/indexes/reviews/query`, {
        headers,
        method: "POST",
        body: JSON.stringify({
  ...
  async function getUserByHomeId(homeId) {
    try {
      return Object(fetchUtils["b" /* unwrap */])(await fetch(`https://${$config.algolia.appId}-dsn.algolia.net/1/indexes/users/query`, {
        headers,
        method: "POST",
        body: JSON.stringify({
          filters: `homeId:${homeId}`,
  ...
  async function getHomesByLocation(lat, lng, start, end, radiusInMeters = 1500 * 15) {
    ...
    try {
      ...
      return Object(fetchUtils["b" /* unwrap */])(await fetch(`https://${$config.algolia.appId}-dsn.algolia.net/1/indexes/homes/query`, {
        headers,
        method: "POST",
        body: JSON.stringify({
...
/* Plugins */
 ...
 // Source: ../plugins/vCalendar.client (mode: 'client')
