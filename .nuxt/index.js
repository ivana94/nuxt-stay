...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"titleTemplate":"Nuxt Stay: %s","htmlAttrs":{"lang":"en"},"bodyAttrs":{"class":["my-style"]},"meta":[{"charset":"utf-8"}],"link":[],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_8f24dd6e === 'function') {
    await nuxt_plugin_plugin_8f24dd6e(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_4e16bb58 === 'function') {
    await nuxt_plugin_pluginclient_4e16bb58(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_3eae13dc === 'function') {
